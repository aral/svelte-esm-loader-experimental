...
var Page = class extends SvelteComponent {
  constructor(options) {
    super();
...
function create_fragment4(ctx) {
  ...
  return {
    ...
    l(nodes) {
      claim_component(pagelayout.$$.fragment, nodes);
    },
    m(target, anchor) {
    ...
    p(ctx2, [dirty]) {
      ...
      if (dirty & 7) {
        pagelayout_changes.$$scope = { dirty, ctx: ctx2 };
      }
...
function instance2($$self, $$props, $$invalidate) {
  ...
  setTimeout(() => {
    $$invalidate(1, data = ["and", "this", "could", "be", "an", "update", "from", "the", "server"]);
  }, 2e3);
  $$self.$$set = ($$props2) => {
    if ("name" in $$props2)
